...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="py-20 md:py-28 bg-[#FBF9F5] text-[#0D3C38] relative overflow-hidden"
    >
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#0D3C38]/10 rounded-full blur-[130px] pointer-events-none -mr-24 -mt-16" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-5 relative" id="about-images">
            ...
            >
              <div className="absolute inset-0 rounded-[30px] border-2 border-[#0D3C38]/15 translate-x-4 -translate-y-4 pointer-events-none" />
              ...
              <motion.div
                ...
                className="absolute -right-4 sm:-right-6 top-10 sm:top-12 bg-[#0D3C38] text-white p-4 sm:p-5 rounded-2xl shadow-xl max-w-[210px] z-20 border border-[#E6B055]/20"
              >
              ...
              <div className="relative rounded-[28px] overflow-hidden aspect-[3/4] shadow-2xl bg-white border-4 border-white/90">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0D3C38]/25 via-transparent to-transparent pointer-events-none" />
              </div>
            </motion.div>
          </div>
          ...
          >
            <motion.div variants={itemVariants} className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0D3C38]/8 border border-[#0D3C38]/15 backdrop-blur-sm">
                <HeartHandshake className="w-3.5 h-3.5 text-[#E6B055]" />
                <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#0D3C38]">
                  About the Practice
                </span>
              </div>

              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-[#0D3C38] font-bold tracking-tight leading-[1.12]">
                Empowering your true, authentic self.
              </h2>

              <p className="text-[#0D3C38]/80 font-normal text-base sm:text-lg leading-relaxed">
            ...
            >
              {coreValues.map((val, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="group relative flex gap-4 items-start p-4 sm:p-5 rounded-2xl bg-white border border-[#0D3C38]/10 hover:border-[#0D3C38]/30 hover:shadow-xl hover:shadow-[#0D3C38]/8 transition-all duration-300"
                  >
                    ...
                    <div className="w-11 h-11 rounded-xl bg-[#0D3C38]/8 flex items-center justify-center shrink-0 group-hover:bg-[#0D3C38] group-hover:scale-110 transition-all duration-300">
                      <Icon className="w-5 h-5 text-[#0D3C38] group-hover:text-white transition-colors duration-300" />
                    </div>

                    <div className="space-y-1.5 flex-1">
                      <h4 className="font-serif text-lg font-semibold text-[#0D3C38]">
                        {val.title}
                      </h4>
                      <p className="text-sm font-normal text-[#0D3C38]/75 leading-relaxed">
                        {val.desc}
                      </p>
                    </div>

                    <div className="absolute bottom-4 left-[76px] h-1 w-10 rounded-full bg-gradient-to-r from-[#0D3C38] via-[#0D3C38]/80 to-[#E6B055] opacity-0 group-hover:opacity-80 group-hover:w-20 transition-all duration-500" />
                  </div>
                );
              })}
            </motion.div>
            ...
            <motion.div
              variants={itemVariants}
              className="pt-6 mt-2 border-t border-[#0D3C38]/10 flex items-center gap-4"
            >
              ...
              <div>
                <span className="font-serif text-[#0D3C38] font-semibold block">
                  Ila Garg
                </span>
                <span className="text-xs text-[#0D3C38]/75 font-medium">
