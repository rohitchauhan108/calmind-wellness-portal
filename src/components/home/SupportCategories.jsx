...
export default function SupportCategories() {
  ...
  const renderCard = (cat, index, source = 'grid') => {
    ...
    return (
      <motion.a
        ...
        whileHover={{ y: -6 }}
        className="group relative h-full rounded-[1.75rem] bg-white border border-[#0D3C38]/8 hover:border-[#0D3C38]/20 hover:shadow-[0_24px_48px_-16px_rgba(13,60,56,0.12)] transition-all duration-500 cursor-pointer overflow-hidden flex flex-col"
      >
        <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-[#0D3C38]/0 via-[#E6B055] to-[#0D3C38]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        ...
        <div className="relative z-10 p-6 sm:p-7 flex flex-col flex-grow">
          <div className="flex items-start justify-between mb-5">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-[#0D3C38]/[0.06] group-hover:bg-[#0D3C38] flex items-center justify-center transition-all duration-400 group-hover:scale-110 shadow-sm group-hover:shadow-[0_10px_24px_-8px_rgba(13,60,56,0.35)]">
              <Icon className="w-7 h-7 sm:w-8 sm:h-8 text-[#0D3C38] group-hover:text-white transition-colors duration-300" />
            </div>
          </div>
          ...
          <h3 className="text-2xl sm:text-3xl font-serif font-bold text-[#0D3C38] mb-3 leading-tight">
            {cat.title}
          </h3>

          <p className="text-sm sm:text-[15px] text-[#0D3C38]/70 font-normal leading-relaxed flex-grow">
            {cat.description}
          </p>

          <div className="mt-6 pt-5 border-t border-[#0D3C38]/8 flex items-center justify-between">
            <span className="text-xs sm:text-[13px] font-semibold text-[#0D3C38]/75 tracking-wide group-hover:text-[#0D3C38] transition-colors duration-300">
              Explore this path
            </span>
            <span className="w-9 h-9 rounded-full bg-[#0D3C38]/[0.06] flex items-center justify-center group-hover:bg-[#E6B055] group-hover:translate-x-1 transition-all duration-400">
              <ArrowRight className="w-4 h-4 text-[#0D3C38] group-hover:text-white transition-colors duration-300" />
            </span>
          </div>
        </div>
      </motion.a>
  ...
  return (
    <section
      id="areas"
      className="py-16 sm:py-20 lg:py-28 bg-[#FBF9F5] text-[#0D3C38] relative overflow-hidden"
    >
      ...
      <div className="absolute top-0 right-0 w-[550px] h-[550px] bg-[#0D3C38]/10 rounded-full blur-[150px] pointer-events-none -mr-32 -mt-10" />
      ...
      <div className="max-w-[90rem] mx-auto px-6 md:px-10 lg:px-12 relative z-10">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-14 sm:mb-16 lg:mb-20 space-y-5">
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-[#0D3C38]/8 border border-[#0D3C38]/15 backdrop-blur-sm shadow-sm"
          >
          ...
          <motion.h2
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif text-[#0D3C38] font-bold tracking-tight leading-[1.08]"
          >
            What do you want{' '}
          ...
          <motion.p
            ...
            className="text-[#0D3C38]/70 text-base sm:text-lg lg:text-xl font-normal leading-relaxed max-w-2xl"
          >
          ...
          >
            ...
            <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#0D3C38]/60">
        ...
        <div className="md:hidden">
          ...
          <div className="flex items-center justify-center mt-6 px-1 gap-4">
            <button
              ...
              className="w-11 h-11 rounded-full bg-white border border-[#0D3C38]/15 text-[#0D3C38] hover:bg-[#0D3C38] hover:text-white transition-all duration-300 flex items-center justify-center shadow-md hover:shadow-lg active:scale-95"
            >
