...
export default function MeetUs() {
  ...
  const profiles = [
    ...
    },
    {
      ...
      cta: "Meet Shilpa",
      link: "/about#shilpa",
      accent: "from-[#0D3C38]/70 via-[#0D3C38] to-[#0D3C38]/70",
    },
  ];
  ...
  return (
    <section
      id="meet-us"
      className="py-16 sm:py-20 md:py-28 bg-gradient-to-br from-[#FBF9F5] via-[#F3E3BD] to-[#FBF9F5] text-[#0D3C38] relative overflow-hidden"
    >
      ...
      <div className="absolute top-0 left-0 w-[350px] h-[350px] sm:w-[500px] sm:h-[500px] bg-[#0D3C38]/8 rounded-full blur-[100px] sm:blur-[130px] pointer-events-none -ml-16 -mt-12 sm:-ml-24 sm:-mt-16" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0D3C38]/8 border border-[#0D3C38]/15 backdrop-blur-sm">
            <Users className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#E6B055]" />
            <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.2em] text-[#0D3C38]">
              Section 5 · Meet Us
            </span>
          </div>

          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#0D3C38] font-bold tracking-tight leading-[1.15] sm:leading-[1.12]">
            Meet the People Behind the Work
          </h2>

          <p className="text-sm sm:text-base lg:text-lg text-[#0D3C38]/70 font-normal leading-relaxed">
            Different approaches.{" "}
            <span className="italic text-[#0D3C38] font-medium">One belief</span>{" "}
        ...
        >
          {profiles.map((profile, index) => (
            <motion.div
              ...
              className="group relative bg-white rounded-[24px] sm:rounded-[32px] border border-[#0D3C38]/10 overflow-hidden shadow-premium hover:shadow-premium-hover transition-all duration-500 flex flex-col"
            >
              <div
              ...
              <div className="relative aspect-[4/5] sm:aspect-[4/5] overflow-hidden bg-[#FAF7F2]">
                <div className="absolute inset-0 rounded-[24px] sm:rounded-[32px] border-2 border-[#0D3C38]/8 translate-x-2 -translate-y-2 sm:translate-x-3 sm:-translate-y-3 pointer-events-none z-10" />
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0D3C38]/35 via-transparent to-transparent pointer-events-none" />
                ...
                <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 z-20">
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 sm:px-3 sm:py-1 rounded-full bg-white/90 backdrop-blur-md border border-white/50 shadow-md">
                    ...
                    <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.16em] sm:tracking-[0.18em] text-[#0D3C38]">
                      {profile.role}
                    </span>
                  </div>
                </div>
              ...
              <div className="p-5 sm:p-7 lg:p-8 flex flex-col flex-grow space-y-4 sm:space-y-5">
                <div className="space-y-1.5 sm:space-y-2">
                  <h3 className="text-xl sm:text-2xl lg:text-3xl font-serif font-bold text-[#0D3C38] tracking-tight leading-tight">
                    {profile.name}
                  </h3>
                </div>

                <p className="text-sm sm:text-[15px] text-[#0D3C38]/75 font-normal leading-relaxed flex-grow">
                  {profile.description}
                </p>

                <div className="pt-3 sm:pt-4 mt-1 sm:mt-2 border-t border-[#0D3C38]/8">
                  <a
                    href={profile.link}
                    className="group/btn inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl bg-[#0D3C38] hover:bg-[#0D3C38]/90 text-[#FBF9F5] font-semibold text-xs sm:text-sm transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-[#0D3C38]/20 cursor-pointer"
                  >
