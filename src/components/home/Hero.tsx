    ...
    >
      ...
      <div className="max-w-[90rem] mx-auto px-4 sm:px-6 md:px-12 relative z-10 w-full">
        ...
        >
          ...
          {/* Two Premium Program Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-8 items-stretch">
            {/* =========================================================
        CARD 1 — MONEY & ABUNDANCE
    ========================================================= */}
            <div className="group flex flex-col h-full rounded-[24px] sm:rounded-[28px] overflow-hidden bg-white shadow-[0_12px_35px_rgba(7,62,66,0.07)] transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_45px_rgba(7,62,66,0.11)]">
              {/* Image + Content */}
              <div className="relative min-h-[380px] sm:min-h-[410px] md:min-h-[430px] overflow-hidden">
                {/* Background Image */}
                <div
                  className="absolute inset-0 bg-[url('/home/1.webp')] bg-center bg-cover bg-no-repeat transition-transform duration-700 group-hover:scale-[1.02]"
                  aria-hidden="true"
                />
                ...
                {/* Content */}
                <div className="relative z-10 flex flex-col h-full p-6 sm:p-8 md:p-9">
                  {/* Premium Label */}
                  <div>
                    <span className="inline-flex items-center text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.18em] text-white bg-[#B28532] px-3.5 sm:px-4 py-1.5 rounded-full shadow-sm">
                      FIRST SESSION COMPLIMENTARY
                    </span>
                  </div>

                  {/* Program Title */}
                  <h3 className="mt-4 sm:mt-5 text-[30px] sm:text-4xl md:text-5xl font-serif font-bold text-[#073E42] leading-[1.05] tracking-tight">
                    Money &amp;
                    <br />
                    Abundance
                  </h3>
                  ...
                  {/* Description */}
                  <p className="mt-5 sm:mt-6 max-w-[390px] text-[13px] sm:text-[14px] md:text-[15px] text-[#1C2826]/85 leading-relaxed font-medium">
                    Explore the beliefs, emotions and subconscious patterns
                    shaping your relationship with money — and begin opening
                    yourself to greater abundance.
                  </p>
                </div>
              </div>

              {/* Bottom CTA Area */}
              <div className="flex flex-col justify-between p-6 sm:p-8 md:p-9 bg-white">
                {/* Program Details */}
                <p className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.14em] text-[#073E42]">
                  Live Online
                  <span className="mx-2 text-[#B28532]">•</span>
                  First Session Complimentary
                </p>
                ...
                <button
                  onClick={handleRegister}
                  className="group mt-5 inline-flex w-full sm:w-[58%] items-center justify-center gap-2 px-5 py-3.5 rounded-full bg-[#073E42] text-white text-[11px] sm:text-xs md:text-sm font-bold uppercase tracking-[0.1em] hover:bg-[#063033] active:scale-[0.99] transition-all duration-300 shadow-[0_8px_20px_rgba(7,62,66,0.18)] hover:-translate-y-0.5 cursor-pointer"
                >
                  I'M INTERESTED
    ...
    ========================================================= */}
            <div className="group flex flex-col h-full rounded-[24px] sm:rounded-[28px] overflow-hidden bg-white shadow-[0_12px_35px_rgba(7,62,66,0.07)] transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_45px_rgba(7,62,66,0.11)]">
              ...
              <div className="relative min-h-[380px] sm:min-h-[410px] md:min-h-[430px] overflow-hidden">
                {/* Background Image */}
                <div
                  className="absolute inset-0 bg-[url('/home/2.webp')] bg-center bg-cover bg-no-repeat transition-transform duration-700 group-hover:scale-[1.02]"
                  aria-hidden="true"
                />

                {/* Soft overlay for text readability */}
                <div
                  className="absolute inset-0 bg-gradient-to-r from-white via-white/90 to-white/15"
                  aria-hidden="true"
                />
                ...
                <div className="relative z-10 flex flex-col h-full p-6 sm:p-8 md:p-9">
                  {/* Premium Label */}
                  <div>
                    <span className="inline-flex items-center text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.18em] text-white bg-[#073E42] px-3.5 sm:px-4 py-1.5 rounded-full shadow-sm">
                      FIRST SESSION COMPLIMENTARY
                    </span>
                  </div>
                  ...
                  {/* Description */}
                  <div className="mt-5 sm:mt-6 max-w-[410px] text-[13px] sm:text-[14px] md:text-[15px] text-[#1C2826]/85 leading-relaxed font-medium space-y-3">
                    <p>
                      Have you tried diets, workouts or routines again and
                      again, only to find yourself falling back into the same
                      patterns?
                    </p>

                    <p>
                      Explore what may be underneath cravings, emotional eating,
                      overeating and inconsistency — beyond simply focusing on
                      food and exercise.
                    </p>
                  </div>
                </div>
