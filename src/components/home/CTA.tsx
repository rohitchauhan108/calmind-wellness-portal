...
export default function CTA() {
  ...
  return (
    <section
      id="cta"
      className="py-24 md:py-32 bg-[#FBF9F5] text-[#0D3C38] relative overflow-hidden"
    >
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[500px] bg-[#0D3C38]/8 rounded-full blur-[150px] pointer-events-none -mt-20" />
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0D3C38]/8 border border-[#0D3C38]/15 backdrop-blur-sm mx-auto">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-bold text-[#0D3C38] tracking-tight leading-[1.05]">
            Your life changes when{" "}
            <span className="italic font-normal text-[#E6B055]">you do.</span>
          </h2>

          <div className="space-y-4 max-w-2xl mx-auto">
            <p className="text-lg sm:text-xl text-[#0D3C38]/75 font-normal leading-relaxed">
              You don't need to have everything figured out before you begin.
            </p>
            <p className="text-base sm:text-lg text-[#0D3C38]/70 font-normal leading-relaxed">
