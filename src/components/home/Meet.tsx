...
function Meet() {
  return (
    <>
    <section id="ila" className="relative scroll-mt-32 overflow-hidden py-20 lg:py-28 px-6 lg:px-12 bg-gradient-to-br from-[#FBF9F5] via-[#F7EAD0] to-[#E6B055]/25">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#0D3C38] leading-[1.15]">
