...
export default function TransformationHero() {
  ...
  return (
    <main className="bg-[#FBF9F5] text-[#0D3B36] antialiased selection:bg-[#0D3B36]/10 selection:text-[#0D3B36] font-sans">
      ...
      <section
        id="ila"
        className="relative scroll-mt-32 overflow-hidden py-20 lg:py-28 px-6 lg:px-12 bg-[#F2F5F3]"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-5 text-base sm:text-lg leading-relaxed text-[#0D3B36]/75 max-w-2xl">
              <p>
            ...
            <div className="relative mt-8 pl-6 border-l-2 border-[#0D3B36]/20 space-y-4">
              <p className="text-lg sm:text-xl font-serif italic text-[#0D3B36] leading-relaxed">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-[#0D3B36]/75 max-w-2xl pt-2">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="absolute -bottom-6 -left-6 w-32 h-32 rounded-full bg-[#0D3B36]/10 blur-2xl" />
              ...
              <div className="absolute bottom-5 left-5 right-5">
                <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-white/90 backdrop-blur-md shadow-lg border border-white/60">
                  <span className="w-2 h-2 rounded-full bg-[#0D3B36]" />
                  <span className="text-sm font-medium text-[#0D3B36]">
