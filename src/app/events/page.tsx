...
const statusBadge = (status: DummyEvent["status"]) => {
  switch (status) {
    case "Upcoming":
      return "bg-[#0D3C38]/8 text-[#0D3C38] border-[#0D3C38]/15";
    case "Waitlist":
      return "bg-[#E6B055]/12 text-[#A07A2F] border-[#E6B055]/30";
    case "Sold Out":
      return "bg-[#C48F3A]/10 text-[#C48F3A] border-[#C48F3A]/15";
    case "Past":
      return "bg-[#0D3C38]/8 text-[#0D3C38]/70 border-[#0D3C38]/10";
    default:
      return "bg-[#0D3C38]/8 text-[#0D3C38] border-[#0D3C38]/15";
  }
};
...
export default function EventsPage() {
  ...
  return (
    <main className="bg-[#FBF9F5] text-[#0D3C38] antialiased min-h-screen selection:bg-[#0D3C38]/10 selection:text-[#0D3C38]">
      {/* ============== SECTION 1 — HERO ============== */}
      <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 px-6 lg:px-12 border-b border-[#0D3C38]/8 overflow-hidden">
        ...
        <div className="absolute -top-24 -right-24 w-[520px] h-[520px] bg-[#0D3C38]/10 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto text-center space-y-6 relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0D3C38]/8 border border-[#0D3C38]/15 text-[#0D3C38] text-xs font-bold tracking-[0.2em] uppercase">
            <Sparkles className="w-3.5 h-3.5 text-[#E6B055]" />
            <span>Live & In-Person Experiences</span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl text-[#0D3C38] leading-[1.08] font-bold max-w-4xl mx-auto">
          ...
          <p className="text-base sm:text-lg text-[#0D3C38]/70 font-normal max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#0D3C38] text-white text-sm font-medium shadow-md hover:bg-[#08292C] transition-all duration-300 group"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full border border-[#0D3C38]/20 text-[#0D3C38] text-sm font-medium hover:bg-[#0D3C38]/5 transition-all duration-300"
            >
              See Past Highlights
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-10 max-w-3xl mx-auto">
            <div className="flex flex-col items-center gap-2 text-center">
              <div className="w-10 h-10 rounded-2xl bg-white border border-[#0D3C38]/10 flex items-center justify-center text-[#0D3C38]">
                <Users className="w-5 h-5" />
              </div>
              <div className="text-xs font-bold uppercase tracking-[0.18em] text-[#0D3C38]/60">
                Intimate Groups
              </div>
              <div className="text-sm text-[#0D3C38]/75">
        ...
        <div className="max-w-7xl mx-auto space-y-10 lg:space-y-12">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div className="space-y-3 max-w-2xl">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl text-[#0D3C38] font-bold leading-tight">
                Reserve your seat at the next gathering.
              </h2>
              <p className="text-base text-[#0D3C38]/70 leading-relaxed">
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-xs font-semibold tracking-wider uppercase transition-all duration-300 border ${
                      active
                        ? "bg-[#0D3C38] text-white border-[#0D3C38] shadow-md"
                        : "bg-white text-[#0D3C38]/80 border-[#0D3C38]/12 hover:border-[#0D3C38]/25 hover:text-[#0D3C38]"
                    }`}
                  >
                    {filter.label}
                  </button>
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20 rounded-3xl bg-white border border-[#0D3C38]/8">
              <div className="text-[#0D3C38]/50 text-sm mb-2">
                No upcoming events match this filter right now.
              </div>
              <button
                onClick={() => setActiveFilter("all")}
                className="text-[#0D3C38] text-sm font-semibold underline underline-offset-4 hover:text-[#E6B055]"
              >
                Reset filters →
              </button>
            </div>
              ...
              {filtered.map((ev, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="relative rounded-[1.75rem] overflow-hidden shadow-[0_24px_48px_-16px_rgba(13,60,56,0.18)] border border-[#0D3C38]/8 group">
                        ...
                        <div className="absolute top-5 left-5 bg-white/95 backdrop-blur-sm rounded-2xl px-4 py-3 shadow-md border border-[#0D3C38]/8 text-center min-w-[72px]">
                          <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#E6B055]">
                            {ev.month}
                          </div>
                          <div className="text-2xl font-bold text-[#0D3C38] leading-none">
                            {ev.dateShort}
                          </div>
                        </div>
                        {/* Status pill */}
                    ...
                    >
                      {/* Metadata line */}
                      <div className="flex flex-wrap items-center gap-3 text-xs font-bold uppercase tracking-[0.18em] text-[#0D3C38]/55">
                        <span className="text-[#0D3C38]">#0{index + 1}</span>
                        <span>·</span>
                      ...
                      <div className="space-y-2">
                        <h3 className="text-3xl sm:text-4xl text-[#0D3C38] font-bold leading-[1.15]">
                          {ev.title}
                        </h3>
                        <p className="text-sm sm:text-base text-[#0D3C38]/75 font-medium italic">
                          {ev.tagline}
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="flex items-start gap-3 rounded-2xl bg-white border border-[#0D3C38]/8 px-4 py-3">
                          <Calendar className="w-4 h-4 text-[#E6B055] mt-0.5 shrink-0" />
                          <div className="space-y-0.5">
                            <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#0D3C38]/50">
                              When
                            </div>
                            <div className="text-sm text-[#0D3C38]/85 leading-snug">
                              {ev.date}
                              <span className="block text-[#0D3C38]/65 text-[13px] mt-0.5">
                      ...
                      {/* Description */}
                      <p className="text-sm sm:text-[15px] text-[#0D3C38]/75 leading-relaxed">
                        {ev.description}
                      </p>

                      {/* Highlights */}
                      <div className="space-y-3">
                        <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#0D3C38]/55">
                          What&apos;s Inside
                        </div>
                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-2.5">
                          {ev.highlights.map((h, i) => (
                            <li
                              key={i}
                              className="flex items-start gap-2 text-sm text-[#0D3C38]/80 leading-snug"
                            >
                              <CheckCircle2 className="w-4 h-4 text-[#0D3C38] shrink-0 mt-0.5" />
                              <span>{h}</span>
                            </li>
                          ))}
                        </ul>
                      ...
                      <div className="pt-5 border-t border-[#0D3C38]/10 space-y-5">
                        <div className="flex flex-wrap items-start justify-between gap-5">
                          <div className="space-y-1 max-w-md">
                            <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#0D3C38]/50">
                              Best For
                            </div>
                            <p className="text-sm text-[#0D3C38]/75">
                              {ev.audience}
                            </p>
                            <p className="text-[12px] text-[#0D3C38]/60 font-medium pt-1">
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-3xl font-bold text-[#0D3C38] mt-0.5">
                              {ev.price}
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                          <button
                            ...
                            className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#0D3C38] text-white text-sm font-semibold shadow-md hover:bg-[#08292C] transition-all duration-300 disabled:bg-[#0D3C38]/40 disabled:cursor-not-allowed group"
                          >
                            {ev.status === "Waitlist"
                              ? "Join the Waitlist"
                              : ev.status === "Sold Out"
                          ...
                          <Link
                            href="/contact"
                            className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full border border-[#0D3C38]/15 text-[#0D3C38] text-sm font-semibold hover:bg-[#0D3C38]/5 transition-all duration-300"
                          >
      ...
      <section
        id="past-highlights"
        className="py-16 lg:py-28 px-6 lg:px-12 bg-[#FBF9F5] relative overflow-hidden"
      >
        <div className="absolute top-20 right-10 w-[420px] h-[420px] bg-[#0D3C38]/6 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto relative z-10 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {visiblePast.map((ev) => (
              <article
                key={ev.id}
                className="group rounded-[1.75rem] bg-white border border-[#0D3C38]/8 overflow-hidden shadow-[0_16px_40px_-20px_rgba(13,60,56,0.15)] hover:shadow-[0_28px_60px_-24px_rgba(13,60,56,0.22)] transition-all duration-500 flex flex-col"
              >
                <div className="relative aspect-[16/10] w-full overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm rounded-xl px-3 py-2 text-center shadow-sm border border-[#0D3C38]/8">
                    <div className="text-[9px] font-bold uppercase tracking-[0.18em] text-[#E6B055]">
                      {ev.month}
                    </div>
                    <div className="text-lg font-bold text-[#0D3C38] leading-none">
                      {ev.dateShort}
                    </div>
                  </div>
                  <div className="absolute top-4 right-4 bg-[#0D3C38]/85 backdrop-blur-sm rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-white">
                    {ev.format}
                  </div>
                </div>

                <div className="p-6 sm:p-7 flex flex-col flex-grow space-y-4">
                  <div className="flex flex-wrap items-center gap-2 text-[11px] font-semibold text-[#0D3C38]/60">
                  ...
                  <h3 className="text-xl sm:text-2xl text-[#0D3C38] font-bold leading-tight">
                    {ev.title}
                  </h3>
                  <p className="text-[13px] sm:text-sm text-[#0D3C38]/75 leading-relaxed flex-grow">
                    {ev.description}
                  </p>

                  <ul className="space-y-2 pt-2 border-t border-[#0D3C38]/8">
                    {ev.highlights.slice(0, 3).map((h, i) => (
                      <li
                        key={i}
                        className="flex items-start gap-2 text-[13px] text-[#0D3C38]/75"
                      >
                        <CheckCircle2 className="w-3.5 h-3.5 text-[#0D3C38] shrink-0 mt-0.5" />
                        <span>{h}</span>
                      </li>
                    ))}
                  </ul>
          ...
          {PAST_EVENTS.length > 2 && (
            <div className="flex justify-center pt-4">
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-[#0D3C38]/20 text-[#0D3C38] text-sm font-semibold hover:bg-[#0D3C38]/5 transition-all duration-300"
              >
                {expandedPast ? (
                  <>
                    Show Less
      ...
      <section className="py-16 lg:py-24 px-6 lg:px-12">
        <div className="max-w-5xl mx-auto relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#0D3C38] via-[#12514c] to-[#08292C] p-10 sm:p-14 lg:p-16 text-center shadow-[0_40px_80px_-30px_rgba(13,60,56,0.5)] border border-white/10">
          <div className="absolute -top-24 -right-24 w-[360px] h-[360px] bg-[#E6B055]/25 rounded-full blur-[120px] pointer-events-none" />
          <div className="absolute -bottom-24 -left-24 w-[360px] h-[360px] bg-[#0D3C38]/60 rounded-full blur-[120px] pointer-events-none" />
