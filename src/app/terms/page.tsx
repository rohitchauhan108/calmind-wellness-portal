        ...
        <div className="space-y-6 text-sm sm:text-base leading-relaxed text-[#0D3C38]/85 font-sans">
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li>Digital Courses and Educational Resources</li>
            </ul>
            <p className="mt-2">
              All services are provided for personal growth, self-development, and educational purposes only.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-2">
              All purchases are final and non-refundable. By completing your purchase, you confirm that you have read, understood, and agreed to our Refund Policy.
            </p>
            <p>
              Payments are processed securely through trusted third-party payment providers. We do not store your payment information.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Failure to attend, arriving late, or being unable to participate for any reason does not entitle the client to a refund, credit, transfer, or replacement session.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-2">
              These services are not intended to diagnose, treat, cure, or prevent any medical, psychological, or psychiatric condition.
            </p>
            <p>
              Always seek advice from a qualified healthcare professional regarding any medical or mental health concerns. Do not discontinue prescribed medication or treatment without consulting your healthcare provider.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-2">
              While we strive to provide the highest quality services, we do not guarantee any specific health, financial, emotional, relationship, career, or personal outcomes.
            </p>
            <p>
              Your results depend on many factors, including your commitment, participation, and individual circumstances.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              No content may be copied, reproduced, distributed, modified, or used for commercial purposes without prior written permission.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Any misuse of the website, abusive behaviour, harassment, fraudulent activity, or disruption of our services may result in immediate termination of access without refund.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Any changes become effective immediately upon being published on this website. Continued use of the website or our services constitutes acceptance of the updated Terms.
            </p>
          </div>
